...
titles = ['EField Strength (V/m)', 'Generation Rate (1/m3)', 'Potential (V)',
           'Recombination (1/m3)', 'PLYield (-)']

data_matrices = [EField_matrix, GenerationMatrix, PotentialMatrix,
...
def update(val):
    ...
    for i, matrix in enumerate(data_matrices):
        ...
        #cax_list[i].set_ydata(matrix[frame])
    ...
    axs[-1].set_ylim(8, 0)  # Reverse y-axis for energy diagrams
    ...
    fig.canvas.draw_idle()  # In case you use interactive environments
