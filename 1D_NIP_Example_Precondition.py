...
#The ions are preconditioned at 0.9 V bias and then held fixed while sweeping the voltage to obtain the IV curve.
#Not to be executed without prior solving of Drift_Diffusion_1D_IV_IONS_NIP_Example.py to obtain initial conditions!
...
def solve_for_voltage(voltage, n_values, p_values, a_values, c_values, phi_values):
    ...
    LoadOldSolution = True

    if LoadOldSolution:
        FixedPreconditioning = True
        ...
        if FixedPreconditioning:
            ...
            print("Precondition Voltage: ", applied_voltages_old[voltagevalue], "V, Precondition Location: ", voltagevalue)
