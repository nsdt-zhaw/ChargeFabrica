...
#This is a 3D experimental code.
import os
...
dz = 1.00e-9/StretchFactor #Pixel Width in meters
...
SinusoidalArray = np.ones((MesoLength, 100, 1), dtype=int) * PS_ID  # You can modify shape
Amplitude = 20
dwidth = 35
...
def solve_for_voltage(voltage, n_values, p_values, a_values, c_values, phi_values):
    ...
    dt, MaxTimeStep, desired_residual, DampingFactor, NumberofSweeps, max_iterations = 1e-9, 1e-6, 1e-20, 0.05, 1, 2000
